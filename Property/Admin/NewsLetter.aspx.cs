    ...
    public partial class NewsLetter : System.Web.UI.Page
    {
        ...
        protected void FillGridData()
       {
        ...
        public string SendNewsLetter(NewsLetterModel model)
        {
            ...
            {
                model.Logopath = "http://satishverma.ca/images/logo.png";
            }
           

            if (model.PropertyPhoto  == null || model.PropertyPhoto == "")
            {
                model.PropertyPhoto = "http://satishverma.ca/images/img1.png";
            }
        ...
        public void Firstnewsletter(NewsLetterModel Model)
        {
            ...
            //else
            //{
            //    Model.Logopath = "..http://satishverma.ca/images/MyLogodd%20-%20Copy.png";
            //}
            Model.AdminPhoto = "http://satishverma.ca/images/ajay_shah.jpg";
