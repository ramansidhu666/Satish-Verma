...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="Free-Home">
        <div class="Infomation">
            ...
            <div>
                 <%--  <asp:CompareValidator ID="CompareValidator2" Display="Dynamic" runat="server" Operator="DataTypeCheck" Type="String"
                ControlToValidate="txtProvince" ErrorMessage="Only alphabet allowed" ValidationGroup="FreeHome" />--%>
        ...
        <div class="Infomation">
            ...
            <asp:TextBox ID="txtCity" runat="server" MaxLength="10" PlaceHolder="City"></asp:TextBox>
             <div class="requires_span">
                    <%--<asp:CompareValidator ID="CompareValidator1" Display="Dynamic" runat="server" Operator="DataTypeCheck" Type="String"
                ControlToValidate="txtCity" ErrorMessage="Only alphabet allowed" ValidationGroup="FreeHome" />--%>
